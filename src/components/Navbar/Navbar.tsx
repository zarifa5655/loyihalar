...
function Navbar() {
    return (
        <nav className= "  bg-[#191C1F] p-5 pl-[300px]  flex items-center justify-between">
            <div className="flex gap-2.5 items-center ">
                <button className="text-[#141414] text-[20px] bg-[#F3DE6D] pt-[6px] px-3 py-2 -rotate-3 w-[74px] h-[40px] ">Black</button>
