...
function Navbar2() {
  return (
      <div className="bg-[#1B6392] flex justify-between items-center py-4 px-[300px] ">
      <div><h1 className="text-[14px] text-white">Welcome to Clicon online eCommerce store. </h1></div>
      <div className="flex">
